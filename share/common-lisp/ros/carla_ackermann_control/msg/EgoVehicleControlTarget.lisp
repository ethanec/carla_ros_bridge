...
(cl:defmethod cl:initialize-instance :after ((m <EgoVehicleControlTarget>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EgoVehicleControlTarget)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name carla_ackermann_control-msg:<EgoVehicleControlTarget> is deprecated: use carla_ackermann_control-msg:EgoVehicleControlTarget instead.")))

(cl:ensure-generic-function 'steering_angle-val :lambda-list '(m))
(cl:defmethod steering_angle-val ((m <EgoVehicleControlTarget>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carla_ackermann_control-msg:steering_angle-val is deprecated.  Use carla_ackermann_control-msg:steering_angle instead.")
  (steering_angle m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <EgoVehicleControlTarget>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carla_ackermann_control-msg:speed-val is deprecated.  Use carla_ackermann_control-msg:speed instead.")
  (speed m))

(cl:ensure-generic-function 'speed_abs-val :lambda-list '(m))
(cl:defmethod speed_abs-val ((m <EgoVehicleControlTarget>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carla_ackermann_control-msg:speed_abs-val is deprecated.  Use carla_ackermann_control-msg:speed_abs instead.")
  (speed_abs m))

(cl:ensure-generic-function 'accel-val :lambda-list '(m))
(cl:defmethod accel-val ((m <EgoVehicleControlTarget>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carla_ackermann_control-msg:accel-val is deprecated.  Use carla_ackermann_control-msg:accel instead.")
  (accel m))

(cl:ensure-generic-function 'jerk-val :lambda-list '(m))
(cl:defmethod jerk-val ((m <EgoVehicleControlTarget>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carla_ackermann_control-msg:jerk-val is deprecated.  Use carla_ackermann_control-msg:jerk instead.")
  (jerk m))
