...
(cl:defmethod cl:initialize-instance :after ((m <EgoVehicleControlCurrent>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EgoVehicleControlCurrent)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name carla_ackermann_control-msg:<EgoVehicleControlCurrent> is deprecated: use carla_ackermann_control-msg:EgoVehicleControlCurrent instead.")))

(cl:ensure-generic-function 'time_sec-val :lambda-list '(m))
(cl:defmethod time_sec-val ((m <EgoVehicleControlCurrent>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carla_ackermann_control-msg:time_sec-val is deprecated.  Use carla_ackermann_control-msg:time_sec instead.")
  (time_sec m))
