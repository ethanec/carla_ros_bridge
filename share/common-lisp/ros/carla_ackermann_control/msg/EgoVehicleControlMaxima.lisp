...
(cl:defmethod cl:initialize-instance :after ((m <EgoVehicleControlMaxima>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EgoVehicleControlMaxima)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name carla_ackermann_control-msg:<EgoVehicleControlMaxima> is deprecated: use carla_ackermann_control-msg:EgoVehicleControlMaxima instead.")))
...
(cl:defmethod max_steering_angle-val ((m <EgoVehicleControlMaxima>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carla_ackermann_control-msg:max_steering_angle-val is deprecated.  Use carla_ackermann_control-msg:max_steering_angle instead.")
...
(cl:defmethod max_speed-val ((m <EgoVehicleControlMaxima>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carla_ackermann_control-msg:max_speed-val is deprecated.  Use carla_ackermann_control-msg:max_speed instead.")
  (max_speed m))

(cl:ensure-generic-function 'max_accel-val :lambda-list '(m))
(cl:defmethod max_accel-val ((m <EgoVehicleControlMaxima>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carla_ackermann_control-msg:max_accel-val is deprecated.  Use carla_ackermann_control-msg:max_accel instead.")
  (max_accel m))

(cl:ensure-generic-function 'max_decel-val :lambda-list '(m))
(cl:defmethod max_decel-val ((m <EgoVehicleControlMaxima>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carla_ackermann_control-msg:max_decel-val is deprecated.  Use carla_ackermann_control-msg:max_decel instead.")
  (max_decel m))

(cl:ensure-generic-function 'min_accel-val :lambda-list '(m))
(cl:defmethod min_accel-val ((m <EgoVehicleControlMaxima>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carla_ackermann_control-msg:min_accel-val is deprecated.  Use carla_ackermann_control-msg:min_accel instead.")
  (min_accel m))

(cl:ensure-generic-function 'max_pedal-val :lambda-list '(m))
(cl:defmethod max_pedal-val ((m <EgoVehicleControlMaxima>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carla_ackermann_control-msg:max_pedal-val is deprecated.  Use carla_ackermann_control-msg:max_pedal instead.")
  (max_pedal m))
