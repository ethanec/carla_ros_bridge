...
(cl:in-package carla_ackermann_control-msg)
...
(cl:defclass <EgoVehicleControlInfo> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (restrictions
    ...
    :type carla_ackermann_control-msg:EgoVehicleControlMaxima
    :initform (cl:make-instance 'carla_ackermann_control-msg:EgoVehicleControlMaxima))
   (target
    :reader target
    :initarg :target
    :type carla_ackermann_control-msg:EgoVehicleControlTarget
    :initform (cl:make-instance 'carla_ackermann_control-msg:EgoVehicleControlTarget))
   (current
    :reader current
    :initarg :current
    :type carla_ackermann_control-msg:EgoVehicleControlCurrent
    :initform (cl:make-instance 'carla_ackermann_control-msg:EgoVehicleControlCurrent))
   (status
    :reader status
    :initarg :status
    :type carla_ackermann_control-msg:EgoVehicleControlStatus
    :initform (cl:make-instance 'carla_ackermann_control-msg:EgoVehicleControlStatus))
   (output
    :reader output
    :initarg :output
...
(cl:defmethod cl:initialize-instance :after ((m <EgoVehicleControlInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EgoVehicleControlInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name carla_ackermann_control-msg:<EgoVehicleControlInfo> is deprecated: use carla_ackermann_control-msg:EgoVehicleControlInfo instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <EgoVehicleControlInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carla_ackermann_control-msg:header-val is deprecated.  Use carla_ackermann_control-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'restrictions-val :lambda-list '(m))
(cl:defmethod restrictions-val ((m <EgoVehicleControlInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carla_ackermann_control-msg:restrictions-val is deprecated.  Use carla_ackermann_control-msg:restrictions instead.")
  (restrictions m))

(cl:ensure-generic-function 'target-val :lambda-list '(m))
(cl:defmethod target-val ((m <EgoVehicleControlInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carla_ackermann_control-msg:target-val is deprecated.  Use carla_ackermann_control-msg:target instead.")
  (target m))

(cl:ensure-generic-function 'current-val :lambda-list '(m))
(cl:defmethod current-val ((m <EgoVehicleControlInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carla_ackermann_control-msg:current-val is deprecated.  Use carla_ackermann_control-msg:current instead.")
  (current m))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <EgoVehicleControlInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carla_ackermann_control-msg:status-val is deprecated.  Use carla_ackermann_control-msg:status instead.")
  (status m))

(cl:ensure-generic-function 'output-val :lambda-list '(m))
(cl:defmethod output-val ((m <EgoVehicleControlInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carla_ackermann_control-msg:output-val is deprecated.  Use carla_ackermann_control-msg:output instead.")
  (output m))
